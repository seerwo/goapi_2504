...
import "github.com/seerwo/goapi_2504/cache"
...
type Config struct {
	...
	Token          string `json:"token"`            // 客服回调配置，用于生成签名校验回调请求的合法性
	EncodingAESKey string `json:"encoding_aes_key"` // 客服回调p配置，用于解密回调消息内容对应的密文
}
